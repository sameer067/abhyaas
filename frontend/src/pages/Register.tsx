  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="max-w-md mx-auto flex flex-col min-h-screen">
        ...
        {/* Brand */}
        <motion.div {...fade(0.3)} className="px-6 mb-5 relative z-10">
        ...
        <motion.form
          onSubmit={submit}
          className="flex flex-col gap-4 px-6 pb-5 relative z-10"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        {/* Bottom link */}
        <motion.div {...fade(0.55)} className="pb-10 pt-2 px-6 relative z-10">
